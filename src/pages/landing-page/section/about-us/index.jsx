import {
  IconDestinasiPopuler,
  IconDiskon,
  IconFleksibilitas,
  IconKemudahan,
  IconSpeaker,
} from '@/assets/images/ImagesAbout';
    ...
    <section id="tentang-kami">
      <div className="md:-mx-18 -mx-5 mb-[180px] max-h-[600px] bg-primary-60 p-7 px-0 md:max-h-[430px] xl:-mx-[66px] mt-10"> 
        <div className="mx-auto flex flex-col items-center gap-3 text-center">
          ...
          <h3 className="max-w-[500px] font-sans text-xs text-white sm:text-sm md:max-w-[600px] md:text-base">
            {data[0].description}
          </h3>
