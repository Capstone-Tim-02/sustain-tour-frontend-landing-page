...
export const DestinationPopuler = () => {
  return (
    <section id="destination-populer">
      <div className="mx-auto my-5 flex w-full flex-col gap-6 text-center">
        <h1 className="font-sans text-xl font-bold text-primary-100 sm:text-2xl lg:text-3xl">
          Jelajahi Destinasi Paling Populer
        </h1>
        <h2 className="max-w-lg self-center font-sans text-sm font-normal text-greyDestimate-100">
          Temukan keajaiban dunia di destinasi paling dicari. Mulai petualanganmu sekarang dan raih
          kenangan abadi!
        </h2>

        <div className="flex flex-col justify-center space-y-4 self-center md:flex-row md:space-x-4 md:space-y-0">
