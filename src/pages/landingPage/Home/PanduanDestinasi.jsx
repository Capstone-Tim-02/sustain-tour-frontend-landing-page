import { appstore, iphone13, playstore } from "@/assets/Footer"

export const PanduanDestinasi = () => {
  return (
    <div className="flex bg-[url('@/assets/Footer/footer.png')] bg-cover bg-center overflow-hidden bg-no-repeat lg:px-52 pt-5 md:px-20">
